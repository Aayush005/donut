...
public class ViewCommentsFragment extends Fragment {
    ...
    private int comment_color_firebase;
    ...
    private void addNewComment(String newComment){
        ...
        comment.setComment_color(comment_color_firebase);
        ...
        // commentCardView.setCardBackgroundColor(comment_color);
...
//                                    photo.setPost_color(objectMap.get("post_color").toString());
                                    ...
                                    for (DataSnapshot dSnapshot : singleSnapshot
                                        ...
                                        if((dSnapshot.getValue(Comment.class).getComment_color())==1 ){
                                            comment.setComment_color(Color.parseColor("#FF1744"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==2 ) {
                                            comment.setComment_color(Color.parseColor("#1B5E20"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==3 ) {
                                            comment.setComment_color(Color.parseColor("#039BE5"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==4 ) {
                                            comment.setComment_color(Color.parseColor("#4CAF50"));
                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==5 ) {
                                            comment.setComment_color(Color.parseColor("#FFEB3B"));
                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==6 ) {
                                            comment.setComment_color(Color.parseColor("#E91E63"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==7 ) {
                                            comment.setComment_color(Color.parseColor("#FF5722"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==8 ) {
                                            comment.setComment_color(Color.parseColor("#9C27B0"));
                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==9 ) {
                                            comment.setComment_color(Color.parseColor("#673AB7"));
                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==10 ) {
                                            comment.setComment_color(Color.parseColor("#795548"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==11 ) {
                                            comment.setComment_color(Color.parseColor("#FAFAFA"));

                                        }
                                        else if ((dSnapshot.getValue(Comment.class).getComment_color())==12 ) {
                                            comment.setComment_color(Color.parseColor("#90A4AE"));
                                        }
